    ...
    <div className="min-h-screen bg-sheet-bg text-sheet-text overflow-x-hidden">
      ...
      <header className="sticky top-0 z-30 h-16 border-b border-sheet-border bg-sheet-bg/90 backdrop-blur-md flex items-center px-6 justify-between">
        <div className="flex items-center gap-3">
          <span className="font-extrabold tracking-wide uppercase text-lg font-['Cinzel','Playfair_Display',serif]"><span className="text-slate-900">App</span> <span className="text-blue-600">Hub</span></span>
        </div>
      ...
      <main className="relative z-10 pt-16 pb-16 px-6 max-w-6xl mx-auto">
        <div className="mb-10 text-center">
          <h1 className="text-2xl sm:text-3xl font-extrabold tracking-wide uppercase font-['Cinzel','Playfair_Display',serif] mb-3">
        ...
        <div className={`grid grid-cols-1 ${user?.accountType === "non-owner" ? "max-w-md mx-auto" : "md:grid-cols-2 lg:grid-cols-4"} gap-6`}>
            ...
            <>
              <Link href="/dashboard"
                ...
                <div className="relative z-10">
                  ...
                  <h2 className="text-xl font-extrabold uppercase tracking-wide font-['Cinzel','Playfair_Display',serif]"><span className="text-slate-900">Spread</span><span className="text-blue-600">sheets</span></h2>
                </div>
              ...
              <Link href="/chatbox"
                ...
                <div className="relative z-10">
                  ...
                  <h2 className="text-xl font-extrabold uppercase tracking-wide font-['Cinzel','Playfair_Display',serif]"><span className="text-slate-900">Chat</span><span className="text-blue-600">box</span></h2>
                </div>
          ...
          <div
            ...
            className="group relative h-64 rounded-2xl border border-sheet-border bg-white/60 hover:bg-white hover:border-blue-500/30 hover:shadow-2xl transition-all duration-300 p-6 flex flex-col justify-between overflow-hidden cursor-pointer"
          >
            <div className="absolute top-0 right-0 p-4 opacity-[0.06] group-hover:opacity-[0.12] transition-opacity"><Ruler size={120} className="text-blue-600" /></div>
            <div className="relative z-10">
              <div className="w-12 h-12 rounded-xl bg-blue-500/10 text-blue-600 flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300"><Ruler size={28} /></div>
            ...
            <div className="flex items-center gap-2 text-blue-600 font-semibold text-xs group-hover:gap-3 transition-all"><span>Open Workspace</span><ArrowRight size={16} /></div>
          </div>
          {/* Calculation card — owners only */}
          {user?.accountType === "owner" && (
            <Link href="/calculation"
              ...
              <div className="absolute top-0 right-0 p-4 opacity-[0.06] group-hover:opacity-[0.12] transition-opacity"><Calculator size={120} className="text-blue-600" /></div>
              <div className="relative z-10">
                <div className="w-12 h-12 rounded-xl bg-blue-500/10 text-blue-600 flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300"><Calculator size={28} /></div>
                <h2 className="text-xl font-extrabold uppercase tracking-wide font-['Cinzel','Playfair_Display',serif]">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 animate-in fade-in duration-200">
          <div className="bg-white border border-sheet-border rounded-2xl p-6 w-full max-w-md shadow-2xl space-y-6">
            <div className="flex items-center justify-between border-b border-sheet-border pb-3">
              <h2 className="text-lg font-extrabold uppercase tracking-wide font-['Cinzel','Playfair_Display',serif] flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              {user?.accountType !== "non-owner" && (
                ...
                >
                  ...
                  <span className="text-sm font-extrabold uppercase tracking-wide font-['Cinzel','Playfair_Display',serif]"><span className="text-slate-900">Customer</span> <span className="text-blue-600">Sheet</span></span>
                </button>
              )}
              ...
              {(user?.accountType !== "non-owner" || user?.workType === "polish") && (
                ...
                >
                  ...
                  <span className="text-sm font-extrabold uppercase tracking-wide font-['Cinzel','Playfair_Display',serif]"><span className="text-slate-900">Polish</span> <span className="text-blue-600">Sheet</span></span>
                </button>
              )}
              ...
              {(user?.accountType !== "non-owner" || user?.workType === "cutting") && (
                ...
                >
                  ...
                  <span className="text-sm font-extrabold uppercase tracking-wide font-['Cinzel','Playfair_Display',serif]"><span className="text-slate-900">Cutting</span> <span className="text-blue-600">Sheet</span></span>
                </button>
              )}
            </div>
          </div>
